...
// 配置 - 从环境变量读取密钥
const WEBHOOK_URL = 'https://www.soloboard.app/api/payment/notify/creem';
const SIGNING_SECRET = process.env.CREEM_SIGNING_SECRET || 'whsec_6MzmusMOCJe420udLkejHe';
console.log('🔑 Using SIGNING_SECRET:', SIGNING_SECRET ? SIGNING_SECRET.substring(0, 10) + '...' : 'NOT SET');

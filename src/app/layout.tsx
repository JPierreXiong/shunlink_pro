...
import { JetBrains_Mono, Merriweather, Noto_Sans_Mono, Syne } from 'next/font/google';
...
import { WebsiteStructuredData, OrganizationStructuredData, SoftwareAppStructuredData } from '@/shared/components/seo/structured-data';
...
export default async function RootLayout({
  ...
  return (
    <html
      lang={locale}
      className={`${notoSansMono.variable} ${merriweather.variable} ${jetbrainsMono.variable} ${syne.variable}`}
